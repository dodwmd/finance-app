        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('chart-of-accounts.store') }}" class="space-y-6">
                        @csrf

                        <!-- Account Code -->
                        <div>
                            <x-input-label for="account_code" :value="__('Account Code')" />
                            <x-text-input id="account_code" class="block mt-1 w-full" type="text" name="account_code" :value="old('account_code')" required autofocus autocomplete="off" dusk="account_code" />
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autocomplete="off" dusk="account_name" />
                        ...
                        <div>
                            ...
                            <select id="type" name="type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" dusk="account_type" required>
                                <option value="" disabled {{ old('type') ? '' : 'selected' }}>{{ __('Select an Account Type') }}</option>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" dusk="description">{{ old('description') }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="system_account_tag" class="block mt-1 w-full" type="text" name="system_account_tag" :value="old('system_account_tag')" autocomplete="off" dusk="system_account_tag" />
                        ...
                        <div class="block mt-4">
                            <label for="is_active" class="inline-flex items-center">
                                <input id="is_active" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} dusk="is_active">
                        ...
                        <div class="block mt-4">
                            <label for="allow_direct_posting" class="inline-flex items-center">
                                <input id="allow_direct_posting" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="allow_direct_posting" value="1" {{ old('allow_direct_posting', true) ? 'checked' : '' }} dusk="allow_direct_posting">
